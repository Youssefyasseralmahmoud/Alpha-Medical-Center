...
class Finance_section_in_finance extends StatelessWidget {
  const Finance_section_in_finance({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Finance_section_in_finance_controller controller = Get.put(Finance_section_in_finance_controller());
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: GetBuilder<Finance_section_in_finance_controller>(builder: (controller){
          return
            ...
            TabBarView(
              children: [
                ...
                GetBuilder<Finance_section_in_finance_controller>(builder: (controller){
                  return
