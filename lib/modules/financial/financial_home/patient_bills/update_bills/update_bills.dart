...
import 'package:project_after_update/modules/financial/financial_home/patient_bills/update_bills/update_bills_controller.dart';
...
class update_bill extends StatelessWidget {
  const update_bill({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Update_bills_controller controller=Get.put(Update_bills_controller());
    ...
    return Scaffold(
      ...
      body: SafeArea(
          child: GetBuilder<Update_bills_controller>(builder: (controller){
            return
              Padding(
                  ...
                  child: ListView(
                   // crossAxisAlignment: CrossAxisAlignment.end,
                    children: [
                      ...
                      SizedBox(height: 8),
                      GetBuilder<Update_bills_controller>(builder: (controller){
