...
import 'package:project_after_update/modules/financial/finance_section_in_finanical/finance_section_in_finacne_controller.dart';
import 'package:project_after_update/modules/financial/laboratory_section_in_finanical/laboratory_section_in_finance_controller.dart';
...
class Laboratory_section_in_finance extends StatelessWidget {
  const Laboratory_section_in_finance({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Laboratory_section_in_finance_controller controller = Get.put(Laboratory_section_in_finance_controller());
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: GetBuilder<Laboratory_section_in_finance_controller>(builder: (controller){
          return
            ...
            TabBarView(
              children: [
                ...
                GetBuilder<Laboratory_section_in_finance_controller>(builder: (controller){
                  return
