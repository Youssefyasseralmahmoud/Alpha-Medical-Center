...
import 'package:project_after_update/modules/financial/reception_section_in_finanical/reception_section_in_finance_controller.dart';
...
class Reception_section_in_finance extends StatelessWidget {
  const Reception_section_in_finance({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Reception_section_in_finance_controller controller = Get.put(Reception_section_in_finance_controller());
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: GetBuilder<Reception_section_in_finance_controller>(builder: (controller){
          return
            ...
            TabBarView(
              children: [
                ...
                GetBuilder<Reception_section_in_finance_controller>(builder: (controller){
                  return
