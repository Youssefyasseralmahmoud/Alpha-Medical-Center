...
import 'package:project_after_update/modules/financial/store_section_in_finanical/store_section_infinance_controller.dart';
...
class Store_section_in_finance extends StatelessWidget {
  const Store_section_in_finance({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Store_section_in_finance_controller controller = Get.put(Store_section_in_finance_controller());
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: GetBuilder<Store_section_in_finance_controller>(builder: (controller){
          return
            ...
            TabBarView(
              children: [
                ...
                GetBuilder<Store_section_in_finance_controller>(builder: (controller){
                  return
