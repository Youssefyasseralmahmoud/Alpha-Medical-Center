...
import 'package:project_after_update/modules/financial/xray_section_in_finanical/xray_section_in_finance_controller.dart';
...
class Xray_section_in_finance extends StatelessWidget {
  const Xray_section_in_finance({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Xray_section_in_finance_controller controller = Get.put(Xray_section_in_finance_controller());
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: GetBuilder<Xray_section_in_finance_controller>(builder: (controller){
          return
            ...
            TabBarView(
              children: [
                ...
                GetBuilder<Xray_section_in_finance_controller>(builder: (controller){
                  return
