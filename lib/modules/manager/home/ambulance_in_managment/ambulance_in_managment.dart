...
import 'package:project_after_update/modules/manager/home/ambulance_in_managment/ambulance_in_managment_controller.dart';
...
class Ambulance_in_managment extends StatelessWidget {
  const Ambulance_in_managment({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Ambulance_in_managment_controller controller = Get.put(Ambulance_in_managment_controller());
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: GetBuilder<Ambulance_in_managment_controller>(builder: (controller){
          return
            ...
            TabBarView(
              children: [
                ...
                //           height: MediaQuery.of(context).size.height * 0.6,
                //           child:
                //           GetBuilder<Ambulance_in_managment_controller>(
                //               builder: (controller) {
                ...
                //   ),
                // ),
                GetBuilder<Ambulance_in_managment_controller>(builder: (controller){
                  return
                                      ...
                                      Container(
                                        child: Row(
                                          children: [
                                            GestureDetector(
                                              onTap: (){
                                                Get.toNamed("/Details_of_user_ambulance",arguments: {
