...
class Add_clinics_service extends StatelessWidget {
  const Add_clinics_service({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Add_clinics_services_controller controller =
    Get.put<Add_clinics_services_controller>(Add_clinics_services_controller());
    return Scaffold(
        body: GetBuilder<Add_clinics_services_controller>(builder: (controller){
          return
            Container(
              child: ListView(
                children: [
