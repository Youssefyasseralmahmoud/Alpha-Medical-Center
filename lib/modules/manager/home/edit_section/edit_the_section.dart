...
class Edit_section extends StatelessWidget {
  const Edit_section({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Edit_section_controller controller =Get.put(Edit_section_controller());
    return Scaffold(
        body: GetBuilder<Edit_section_controller>(builder: (controller){
          return
