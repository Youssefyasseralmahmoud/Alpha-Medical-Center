...
class Add_laboratory_service extends StatelessWidget {
  const Add_laboratory_service({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Add_laboratory_services_controller controller =
    Get.put<Add_laboratory_services_controller>(Add_laboratory_services_controller());
    return Scaffold(
        body: GetBuilder<Add_laboratory_services_controller>(builder: (controller){
          return
            Container(
              child: ListView(
                children: [
