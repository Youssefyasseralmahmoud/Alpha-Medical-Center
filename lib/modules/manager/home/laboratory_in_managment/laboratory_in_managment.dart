...
import 'package:project_after_update/modules/manager/home/laboratory_in_managment/laboratory_in_managment_controller.dart';
import 'package:project_after_update/static_colors/StaticColors.dart';

class Laboratory_in_managment extends StatelessWidget {
  const Laboratory_in_managment({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: GetBuilder<Laboratory_in_managment_controller>(builder: (controller){
          return
