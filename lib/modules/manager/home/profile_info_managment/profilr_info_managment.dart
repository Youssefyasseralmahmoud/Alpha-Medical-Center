...
class Profile_info_managment extends StatelessWidget {
  const Profile_info_managment({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: GetBuilder<Profile_info_managment_controller>(builder: (controller) {
          return
