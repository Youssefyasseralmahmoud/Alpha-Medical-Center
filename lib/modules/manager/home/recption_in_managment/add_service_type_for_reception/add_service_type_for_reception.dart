...
class Add_service_type_for_reception extends StatelessWidget {
  const Add_service_type_for_reception({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Add_service_type_rec_controller controller =
    Get.put<Add_service_type_rec_controller>(Add_service_type_rec_controller());
    return Scaffold(
        body: GetBuilder<Add_service_type_rec_controller>(builder: (controller){
          return
            Container(
              child: ListView(
                children: [
