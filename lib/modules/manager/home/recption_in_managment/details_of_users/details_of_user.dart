...
class Details_of_user extends StatelessWidget {
  const Details_of_user({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Details_of_user_controller controller = Get.put(Details_of_user_controller());
    return Scaffold(
        body: GetBuilder<Details_of_user_controller>(builder: (controller){
          return
