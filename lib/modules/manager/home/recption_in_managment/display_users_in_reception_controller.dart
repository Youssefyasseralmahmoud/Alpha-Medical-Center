...
class display_user_in_reception_controller extends GetxController {
  bool droped = false;
  Display_user_in_reception_services services = Display_user_in_reception_services(Get.find(),Get.find());
