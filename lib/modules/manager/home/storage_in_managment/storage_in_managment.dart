...
class Storage_in_managment extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Storage_in_manamgment_controller controller =
    Get.put<Storage_in_manamgment_controller>(
        Storage_in_manamgment_controller());
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return GestureDetector(
                          onTap: () {
                            Get.toNamed("/Storage_details_in_managment");
                          },
                          child: Container(
                            ...
                            children: const [
                              Text(
                               ...
                               Text("تاريخ الإنتاج  : 2023-7-1",style: TextStyle(color: Colors.grey),),
                            ],
                            ),
                          ),
                        );
