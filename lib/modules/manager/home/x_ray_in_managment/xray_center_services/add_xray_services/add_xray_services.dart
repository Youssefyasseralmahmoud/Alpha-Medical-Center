...
import 'package:project_after_update/modules/manager/home/laboratory_in_managment/laboratory_center_services/add_laboratory_services/add_laboratory_service_controller.dart';
import 'package:project_after_update/modules/manager/home/x_ray_in_managment/xray_center_services/add_xray_services/add_xray_service_controller.dart';
import 'package:project_after_update/static_colors/StaticColors.dart';

class Add_xray_service extends StatelessWidget {
  const Add_xray_service({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Add_xray_services_controller controller =
    Get.put<Add_xray_services_controller>(Add_xray_services_controller());
    return Scaffold(
        body: GetBuilder<Add_xray_services_controller>(builder: (controller){
          return
            Container(
              child: ListView(
                children: [
